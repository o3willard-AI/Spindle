...
| Service | IP | Status |
|---|---|---|
| PostgreSQL 16.14 | 198.51.100.101 | ✅ Deployed, zero migrations |
| Cinc Server 15.10.114 | 198.51.100.220 on .155 | ✅ Running, untested with Spindle |
| Cinc Clients (fleet) | 198.51.100.211-213 on .155 | ✅ Running, never connected |
| Clubhouse services | 198.51.100.42 | ✅ LiteLLM, Qdrant, Mem0 |
...
- Run all 21+ migrations against the live PostgreSQL server (198.51.100.101)
...
- SSH to Cinc Server (198.51.100.220)
