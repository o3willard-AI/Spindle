...
The `spindle` database at `198.51.100.101:5432` was **unpopulated** — the S2 ingest
...
```bash
export DATABASE_URL=postgres://spindle:spindle-dev-password@198.51.100.101:5432/spindle
