...
| Issuer | `http://198.51.100.101:5556/dex` |
...
staticClients:
  - id: spindle
    ...
    redirectURIs:
      - http://198.51.100.101:8080/v1/auth/callback
...
```
GET http://198.51.100.101:5556/dex/.well-known/openid-configuration
issuer:                        http://198.51.100.101:5556/dex
authorization_endpoint:        http://198.51.100.101:5556/dex/auth
token_endpoint:                http://198.51.100.101:5556/dex/token
jwks_uri:                      http://198.51.100.101:5556/dex/keys
device_authorization_endpoint: http://198.51.100.101:5556/dex/device/code
```
...
```toml
[identity]
issuer_url    = "http://198.51.100.101:5556/dex"
client_id     = "spindle"
client_secret = "spindle-secret"
redirect_uri  = "http://198.51.100.101:8080/v1/auth/callback"
```
...
Performed against the live server (`198.51.100.101:8080`).
