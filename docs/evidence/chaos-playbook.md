...
5. **client.rb points at the twin-write proxy** (`http://198.51.100.101:8081`)
...
Cinc server target is misconfigured in the proxy (`198.51.100.110` instead of
the documented `198.51.100.220`) and that downstream is unreachable — repair
