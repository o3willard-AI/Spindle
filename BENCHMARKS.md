...
**Server:** `http://192.0.2.10:8080` — live Spindle deployment
...
## 2. Actual results (live deployment — 192.0.2.10:8080)

Tested **2026-08-08** against the live air-gap deployment at `192.0.2.10:8080`.
...
*Results recorded 2026-08-08 — live hardware at 192.0.2.10:8080.*
